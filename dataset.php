		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">Hadith Data</li>
				</ol>
			</div><!--/.row-->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-info">
						<div class="panel panel-heading">Hadith Data</div>
					</div>
				</div>
    		</div><!--/.row-->		
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<table data-toggle="table"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
								<thead>
                                    <tr>
										<th data-field="no" data-sortable="true">Number</th>
										<!-- <th data-field="nomor_hadis" data-sortable="true">Nomor Hadits</th> -->
                                        <th data-field="kitab" data-sortable="true">Book</th>
                                        <th data-field="bab" data-sortable="true">Chapter</th>
                                        <th data-field="hadits" data-sortable="true">Hadith</th>
                                        <th data-field="isi" data-sortable="true">Hadith Translation</th>
                                    </tr>
								</thead>
								<tbody>
								<?php
