			...
			<ul class="nav menu">
				...
				<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
					...
					<ul class="children collapse in" id="sub-item-1">
						...
						<li><a class="active" href="data_thesaurus.php"><span class="fa fa-book">&nbsp;</span>
							Thesaurus Data
						</a></li>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">Thesaurus Data</li>
				</ol>
			</div><!--/.row-->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-info">
						<div class="panel panel-heading">Thesaurus Data</div>
					</div>
				</div>
    		</div><!--/.row-->		
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<table data-toggle="table"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
								<thead>
                                    <tr>
                                        <th data-field="id_tes" data-sortable="true">ID</th>
                                        <th data-field="term" data-sortable="true">Term</th>
                                        <th data-field="tesaurus" data-sortable="true">Thesaurus</th>
                                    </tr>
								</thead>
								<tbody>
								<?php
                                mysqli_query($connect,"SET CHARACTER SET utf8");
                                $query = mysqli_query($connect, "SELECT * FROM tb_tes ORDER by id_tes ASC") or die(("Can't Connect Database"));
                                $no = 1;
